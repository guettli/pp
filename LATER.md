...
Autogenerate a SCRIPTS.md file

it should be generated by the --help calls to all scripts.

Every script must support --help.

SCRIPTS.md should be generated by a script.

During calls this script via Taskfile before deploy.
